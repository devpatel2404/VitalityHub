        ...
        <main>
            <form className={"Quiz"}>
                ...
                <div id={"Health Information"}>
                    ...
                    <input className={"border-2 border-black text-black mt-2 QuizInput4 flex"} style={{marginLeft: 'auto', marginRight: 'auto'}}
                    ...
                    <input className={"border-2 border-black text-black mt-2 mb-16 QuizInput4 flex"} style={{marginLeft: 'auto', marginRight: 'auto'}}
