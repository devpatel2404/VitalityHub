...
export default function Testimonies(){
    ...
    return(
        <main className={"w-screen pt-6 pb-6"}>
                ...
                <div className={"flex justify-center"}>
                    ...
                    <div className={"flex justify-between text-center ml-20 mr-20"} style={{width: '400px'}}>
                        ...
                        <div id={"Testimony0"} hidden={false} style={{marginTop: 'auto', marginBottom: 'auto'}}
                             className={"ml-2 mr-2"}>
                            <h1></h1>
                            <p>VitalityHub keeps me on track with my calories. I&apos;ve seen remarkable progress and
                                regained control of my health!</p>
                        </div>
                        <div id={"Testimony1"} hidden={true} style={{marginTop: 'auto', marginBottom: 'auto'}}
                             className={"ml-2 mr-2"}>
                            <h1></h1>
                            <p>Tracking calories with VitalityHub is effortless. I feel more in control and motivated to
                                reach my goals.</p>
                        </div>
                        <div id={"Testimony2"} hidden={true} style={{marginTop: 'auto', marginBottom: 'auto'}}
                             className={"ml-2 mr-2"}>
                            <h1></h1>
                            <p>With VitalityHub, managing my calories is simple. I&apos;ve made significant progress and
                                feel empowered in my health journey.</p>
                        </div>
                        ...
                        <div id={"Testimony4"} hidden={true} style={{marginTop: 'auto', marginBottom: 'auto'}}
                             className={"ml-2 mr-2"}>
                            <h1></h1>
                            <p>VitalityHub makes calorie tracking a breeze. I&apos;ve seen positive changes in my health
                                and lifestyle.</p>
                        </div>
                        ...
                        <div id={"Testimony6"} hidden={true} style={{marginTop: 'auto', marginBottom: 'auto'}}
                             className={"ml-2 mr-2"}>
                            <h1></h1>
                            <p>Using VitalityHub&apos;s calorie tracker has been life-changing. It&apos;s helped me stay
                                accountable and improve my health.</p>
                        </div>
                        <div id={"Testimony7"} hidden={true} style={{marginTop: 'auto', marginBottom: 'auto'}}
                             className={"ml-2 mr-2"}>
                            <h1></h1>
                            <p>VitalityHub exceeded my expectations for a calorie tracker app. It&apos;s user-friendly
                                and keeps me motivated to reach my goals!</p>
                        </div>
